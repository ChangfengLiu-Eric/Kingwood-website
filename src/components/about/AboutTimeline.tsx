              ...
              <Reveal key={item.year} delay={i * 0.08}>
                <div className="relative grid grid-cols-[88px_1fr] md:grid-cols-[200px_1fr] lg:grid-cols-[260px_1fr] gap-6 md:gap-12">
                  ...
                  <div className="text-right pr-6">
                    <p className="font-serif text-2xl md:text-3xl lg:text-[2rem] font-medium text-ink-900 numeric leading-none">
                      {item.year}
                    </p>
                  </div>

                  {/* 节点圆点 */}
                  <div className="absolute left-[88px] md:left-[200px] lg:left-[260px] -translate-x-1/2 top-2 lg:top-4 w-2.5 h-2.5 rounded-full bg-[#b8923f] ring-4 ring-white" />

                  {/* 右：标题 + 描述 */}
                  <div className="pl-6">
                    <h3 className="font-serif text-lg lg:text-xl font-medium text-ink-900 mb-2">
                      {item.title}
                    </h3>
